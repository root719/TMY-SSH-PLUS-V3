...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/root719/TMY-SSH-PLUS-V3/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/root719/TMY-SSH-PLUS-V3/main/badvpn/antcrashvpn.sh -o /dev/null
